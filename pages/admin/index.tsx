...
const Admin: NextPage = (props) => {
  ...
  return (
    <Box className="w-full h-full flex flex-col items-center pt-20 gap-10">
      ...
      >
        Welcome,{" "}
        <span className="text-blue-500 filter drop-shadow-lg">
          {session?.user.name}
        </span>
      </Typography>
      <MsgForm />
    ...
    <>
      ...
      >
        ...
        <Controller
          name="for"
          control={control}
          render={({ field }) => <TextField label="Send to..." {...field} />}
        />
                ...
                <FormControl>
                  ...
                  <Input
                    ...
                    endAdornment={
                      <InputAdornment
                        position="end"
                        className="bg-gray-800 text-lg pointer-events-none"
                      >
              ...
              return (
                <div>
                  ...
                  <Popper
                    open={isColorOpen}
                    anchorEl={() =>
                      document.querySelector("#colorSelect") as HTMLDivElement
                    }
                    placement="right-end"
                  >
                    <div ref={field.ref}>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <TextField label="Message to Send:" {...field} />
          )}
        />
