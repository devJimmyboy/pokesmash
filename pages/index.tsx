...
const Home: NextPage = () => {
  ...
  const { error, score, currentId } = useSmash() as NonNullable<
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            css={css`
              ...
              cursor: url(https://cdn.7tv.app/emote/609f355eb55466cf076467b1/1x),
                default;
              background-size: 120%;
        ...
        <Footer>
          <CreatedCard
            sx={{ fontSize: [16, 18, 24, 28], fontFamily: "Lilita One" }}
          >
          ...
          <div className="flex flex-col items-start md:items-end h-32 gap-4 mx-6 my-6 w-24">
            ...
            >
              <IconButton
                className="discord-bg w-10 h-10"
                target="_blank"
                href="https://discord.gg/KA49N8H"
              >
            ...
            <div className="pointer-events-auto flex flex-row-reverse  md:flex-row items-center relative group">
              <Blurb
                className={`absolute text-xs md:text-sm pointer-events-none text-center transition-opacity ${
                  seenSupport ? "opacity-0 group-focus-within:opacity-100" : ""
                }`}
              >
                Support me
                <br />
              ...
              <IconButton
                className={`fancy-bg w-10 h-10 ${
                  seenSupport ? "" : "animate-pulse"
                }`}
                target="_blank"
